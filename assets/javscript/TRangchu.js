...
let HeaderProducts = [
    {
        ...
        description: 'Bánh Macaron Pháp với hương vị thơm mềm, giòn tan, béo ngậy. Được mệnh danh là "nữ hoàng" của thế giới bánh ngọt.',
        Image: 'image/sp-nb-02.jpg'
    },
    {
        id:2,
        name: 'Bánh Sachertorte',
        description: 'Bánh Sachertorte làm từ sô cô la đặc biệt, với vị ngọt ngào và mùi hương hấp dẫn. Bánh này bắt nguồn ở Viena, Áo.',
        Image: 'image/sp-nb-01.jpg'
    },
    {
        id:3,
        name: 'Bánh Gateau St Honore',
        description: 'Bánh Gateau St Honore với đế bánh sửa dụng ngàn lớp để tạo nên hay còn gọi là bánh gato.',
        Image: 'Image/sp-nb-03.jpg'
    },
    {
        id:4,
        name:'Bánh Black forest',
        description: 'Bánh Black forest là một loại bánh kem và sô cô la với nhân anh đào phong phú dựa trên một món tráng miệng của Đức.',
        Image: 'image/sp-nb-04.jpg'
    }
]

HeaderProducts.forEach((product)=>{
    let htmls = `
        <div class="prodcut__Item col-md-3 col-sm-6 d-flex justify-content-center mt-3">
        ...
        `
    document.querySelector('.productRow').innerHTML += htmls
})
...
ContnetProduct.forEach((product)=>{
    let htmls =`
        ...
        `
    document.querySelector('.ContentRow').innerHTML += htmls;
})
...
productViewAll.forEach((product)=>{
    let htmls = `
        <div class="col-md-3 col-sm-6 d-flex justify-content-center mb-3">
    ...
    `
    document.querySelector('.ViewAll__SeeAll').innerHTML += htmls
});
